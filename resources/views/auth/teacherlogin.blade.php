...
<div class="container0">
	<section id="content">
		...
		<div class="button">
            ...
            <a class="facebook" href="{{route('social.login',['provider' => 'facebook','type'=>'teacher'])}}"></a>
            <a class="google" href="{{route('social.login',['provider' => 'google','type'=>'teacher'])}}" ></a>
            <a class="github" href="{{route('social.login',['provider' => 'github','type'=>'teacher'])}}"></a>
