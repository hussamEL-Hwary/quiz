...
@section('content')
<form   method="post" action="/teacher/setting" enctype="multipart/form-data">
  {{csrf_field()}}
  <label>Profile Info</label>
  <br>
  <img src="{{$user->profile->avatar}}" alt="profilePic"/><br>
  change Photo
  <input type="file" name="teacher_image" value="">
<br>
...
<form class="" action="/teacher/account" method="post" enctype="multipart/form-data">
  {{csrf_field()}}
